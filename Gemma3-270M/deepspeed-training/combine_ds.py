...
checkpoint_dir = "/home/jovyan/Gemma/ds_checkpoints"
output_file = "/home/jovyan/Gemma/merged_model-375"

# 1. Merge to FP32 first
convert_zero_checkpoint_to_fp32_state_dict(checkpoint_dir, output_file)

# 2. Load and cast to BF16
state_dict = torch.load("/home/jovyan/Gemma/merged_model-375/pytorch_model.bin", map_location="cpu")
state_dict_bf16 = {k: v.to(torch.bfloat16) for k, v in state_dict.items()}

torch.save(state_dict_bf16, "/home/jovyan/Gemma/merged_model_375_bf16.pt")
