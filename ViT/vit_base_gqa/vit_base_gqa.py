...
class GroupedQueryAttention(nn.Module):
    ...
    def __init__(self, embedding_dim, num_heads, num_kv_heads, attn_dropout):
        super().__init__()
        ...
        self.k_proj = nn.Linear(
            embedding_dim, self.num_kv_heads * self.head_dim, bias=False
        )
...
class TransformerEncoderBlock(nn.Module):
    ...
    def __init__(
        self, embedding_dim, num_heads, attn_dropout, mlp_size, dropout, num_kv_heads
    ):
        super().__init__()

        self.msa_block = GroupedQueryAttention(
            embedding_dim, num_heads, num_kv_heads, attn_dropout
        )
